...
!(function () {
  ...
  var o = window.document,
    ...
    G = function (o) {
      return (E > 1 ? t.ceil((t.round(o * E) / E) * 2) / 2 : t.ceil(o)) || 0;
    },
    L = function (o, e) {
    ...
    T = function (e, r) {
      if (null != e && null != r)
        if (
          ...
          var a = f("span");
          _(a.attachShadow({ mode: "closed" }), e, function () {
            r(a);
          });
        } else {
          var n = f("iframe", {
          ...
          var c = function () {
            ...
            w(n, "load", c),
              _.call(l, a, e, function (o) {
                var a = (function (o) {
                  var e = o.offsetWidth,
                    r = o.offsetHeight;
                  if (o.getBoundingClientRect) {
                    var a = o.getBoundingClientRect();
                    (e = t.max(e, G(a.width))), (r = t.max(r, G(a.height)));
                  }
                  return [e, r];
                })(o);
  ...
  e.protocol + "//" + e.host + e.pathname === i
    ? _(o.body, m(window.name || e.hash.replace(/^#/, "")), function () {})
    : (function (e) {
        if (
